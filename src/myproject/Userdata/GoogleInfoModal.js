...
function GoogleInfoModal({ show, onClose, googleUser }) {
  ...
  const handleAutoSaveGoogleInfo = async () => {
    ...
    try {
      ...
      const response = await axios.post(GOOGLE_INFO_API, {
            ...
            <div className="google-info-display">
              <div className="profile-section">
                <div className="profile-image-container">
                  ...
                  <div className="profile-placeholder" style={{display: googleUser.picture ? 'none' : 'flex'}}>
